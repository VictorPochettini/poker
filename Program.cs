public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        while (jogadores.Count(j => j.Fichas > 0) > 1)
        {
            ...
            {
                j.ApostaAtual = 0; // Reseta apostas para nova rodada
            }
            // Reaplica as apostas dos blinds
            smallBlind.ApostaAtual = Math.Min(10, smallBlind.Fichas + 10); // +10 porque já foi descontado
            bigBlind.ApostaAtual = Math.Min(20, bigBlind.Fichas + 20); // +20 porque já foi descontado
